...
namespace Clumsy {
	...
	class RenderInstancedBurnedGroundComponent : public EntityComponent
	{
	public:
		RenderInstancedBurnedGroundComponent(Model* model, std::vector<Transform> transform) : m_Model(model), m_Transform(transform)
		{
		...
		{
			Update(RenderEngine::GetInstance()->groundBurned);
